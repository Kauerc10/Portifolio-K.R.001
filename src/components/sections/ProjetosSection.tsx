...
import { ExternalLink, GitBranch, Lock, Zap, ShieldCheck, CheckCircle2, FileText, Cpu } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
        ...
        >
          <div>
            ...
            <h3 className="text-xl font-extrabold text-slate-900 dark:text-white mb-2 tracking-tight">DocFácil — IA Generativa em Documentos Legais</h3>
            
            {/* Mini Case Study Structure */}
            <div className="space-y-3 text-xs font-mono my-4 border-y border-slate-200 dark:border-white/10 py-4">
              <div>
                <strong className="text-amber-700 dark:text-[var(--gold)] block text-[11px] uppercase tracking-wider mb-0.5 font-bold">■ O PROBLEMA:</strong>
                <p className="text-slate-700 dark:text-gray-300 leading-relaxed font-sans font-normal">Redação manual de documentos jurídicos propensa a inconsistências e burocracia desnecessária.</p>
              </div>

              <div>
                <strong className="text-emerald-700 dark:text-emerald-400 block text-[11px] uppercase tracking-wider mb-0.5 font-bold">⚡ SOLUÇÃO & ARQUITETURA:</strong>
                <p className="text-slate-800 dark:text-gray-300 leading-relaxed font-sans font-normal">
                  Plataforma Next.js 16 com camada de IA agnóstica (<code className="text-emerald-700 dark:text-emerald-400 font-mono font-bold">AIProvider</code>), streaming server-side e suporte plugável a OpenAI, Anthropic e Gemini.
                </p>
              </div>
            </div>

            <span className="inline-block px-3 py-1 rounded-lg bg-slate-100 dark:bg-white/5 text-[11px] text-slate-700 dark:text-gray-300 font-mono border border-slate-200 dark:border-white/10 mb-4">
        ...
        >
          <div>
            ...
            <h3 className="text-xl font-extrabold text-slate-900 dark:text-white mb-2 tracking-tight">Atlas Notarial — Automação com API Detran-RS</h3>

            {/* Mini Case Study Structure */}
            <div className="space-y-3 text-xs font-mono my-4 border-y border-slate-200 dark:border-white/10 py-4">
              <div>
                <strong className="text-amber-800 dark:text-amber-400 block text-[11px] uppercase tracking-wider mb-0.5 font-bold">■ O PROBLEMA:</strong>
                <p className="text-slate-700 dark:text-gray-300 leading-relaxed font-sans font-normal">Emissão manual de procurações de veículos levando 5 minutos de digitação por documento.</p>
              </div>

              <div>
                <strong className="text-emerald-700 dark:text-emerald-400 block text-[11px] uppercase tracking-wider mb-0.5 font-bold">⚡ MÉTRICA DE IMPACTO:</strong>
                <p className="text-slate-800 dark:text-gray-200 leading-relaxed font-sans font-normal">
                  Tempo reduzido de <strong className="text-amber-800 dark:text-amber-400 font-bold">5 minutos para 20 segundos</strong> por procuração com 100% de precisão jurídica.
                </p>
              </div>
            </div>
        ...
        >
          <div>
            ...
            <h3 className="text-xl font-extrabold text-slate-900 dark:text-white mb-2 tracking-tight">CKF Manutenção — Orçamentos & Maquinário</h3>

            {/* Mini Case Study Structure */}
            <div className="space-y-3 text-xs font-mono my-4 border-y border-slate-200 dark:border-white/10 py-4">
              <div>
                <strong className="text-blue-700 dark:text-blue-400 block text-[11px] uppercase tracking-wider mb-0.5 font-bold">■ O PROBLEMA:</strong>
                <p className="text-slate-700 dark:text-gray-300 leading-relaxed font-sans font-normal">Falta de controle centralizado para emissão de orçamentos de manutenção em máquinas pesadas.</p>
              </div>

              <div>
                <strong className="text-emerald-700 dark:text-emerald-400 block text-[11px] uppercase tracking-wider mb-0.5 font-bold">⚡ ARQUITETURA & QUALIDADE:</strong>
                <p className="text-slate-800 dark:text-gray-300 leading-relaxed font-sans font-normal">
        ...
        >
          <div>
            ...
            <h3 className="text-xl font-extrabold text-slate-900 dark:text-white mb-2 tracking-tight">Foli — PDF Layout Engine em TypeScript</h3>

            {/* Mini Case Study Structure */}
            <div className="space-y-3 text-xs font-mono my-4 border-y border-slate-200 dark:border-white/10 py-4">
              <div>
                <strong className="text-purple-700 dark:text-purple-400 block text-[11px] uppercase tracking-wider mb-0.5 font-bold">■ O PROBLEMA:</strong>
                <p className="text-slate-700 dark:text-gray-300 leading-relaxed font-sans font-normal">Quebras de layout e overflow inesperado ao gerar PDFs complexos no Node.js e navegador.</p>
              </div>

              <div>
                <strong className="text-emerald-700 dark:text-emerald-400 block text-[11px] uppercase tracking-wider mb-0.5 font-bold">⚡ ENGENHARIA DA LIB:</strong>
                <p className="text-slate-800 dark:text-gray-300 leading-relaxed font-sans font-normal">
