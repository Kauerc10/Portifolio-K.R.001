    ...
    <section className="section obmep-vault" id="conquistas" data-section="5">
      ...
      <div className="obmep-vault__container">
        ...
        <div className="obmep-vault__grid">
          {/* 2023 - PRATA REGIONAL */}
          <div className="obmep-card magnetic" data-level="prata" data-cursor={dict.medals[0].cursorLabel}>
            <div className="obmep-card__aura"></div>
            <div className="obmep-node-marker"></div>
            <div className="obmep-card__content">
              <svg className="obmep-medal-svg medal-prata" viewBox="0 0 100 130" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '140px', height: '182px', overflow: 'visible', flexShrink: 0 }} aria-label={dict.medals[0].ariaLabel} role="img">
                <defs>
              ...
              <div className="obmep-card__info">
                ...
                <h3 className="obmep-card__title">{dict.medals[0].title}</h3>
                <p className="obmep-card__desc">{dict.medals[0].description}</p>
              </div>
            </div>
          </div>

          {/* 2023 - BRONZE NACIONAL */}
          <div className="obmep-card magnetic" data-level="bronze" data-cursor={dict.medals[1].cursorLabel}>
            <div className="obmep-card__aura"></div>
            <div className="obmep-node-marker"></div>
            <div className="obmep-card__content">
              <svg className="obmep-medal-svg medal-bronze" viewBox="0 0 100 130" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '140px', height: '182px', overflow: 'visible', flexShrink: 0 }} aria-label={dict.medals[1].ariaLabel} role="img">
                <defs>
              ...
              <div className="obmep-card__info">
                <span className="obmep-card__year">2023</span>
                <h3 className="obmep-card__title">{dict.medals[1].title}</h3>
                <p className="obmep-card__desc">{dict.medals[1].description}</p>
              </div>
            </div>
          </div>

          {/* 2022 - MENÇÃO HONROSA */}
          <div className="obmep-card magnetic" data-level="mencao" data-cursor={dict.medals[2].cursorLabel}>
            <div className="obmep-card__aura"></div>
            <div className="obmep-node-marker"></div>
            <div className="obmep-card__content">
              <svg className="obmep-medal-svg medal-honra" viewBox="0 0 100 130" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '140px', height: '182px', overflow: 'visible', flexShrink: 0 }} aria-label={dict.medals[2].ariaLabel} role="img">
                <defs>
              ...
              <div className="obmep-card__info">
                ...
                <h3 className="obmep-card__title">{dict.medals[2].title}</h3>
                <p className="obmep-card__desc">{dict.medals[2].description}</p>
              </div>
            </div>
          </div>

          {/* 2021 - MENÇÃO HONROSA */}
          <div className="obmep-card magnetic" data-level="mencao" data-cursor={dict.medals[3].cursorLabel}>
            <div className="obmep-card__aura"></div>
            <div className="obmep-node-marker"></div>
            <div className="obmep-card__content">
              <svg className="obmep-medal-svg medal-honra" viewBox="0 0 100 130" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '140px', height: '182px', overflow: 'visible', flexShrink: 0 }} aria-label={dict.medals[3].ariaLabel} role="img">
                <defs>
              ...
              <div className="obmep-card__info">
                ...
                <h3 className="obmep-card__title">{dict.medals[3].title}</h3>
                <p className="obmep-card__desc">{dict.medals[3].description}</p>
              </div>
            </div>
          </div>
        </div>
