...
const Animations = (() => {
    ...
    function animateObmepTimeline() {
        ...
        // A linha cresce no compositor, sem recalcular o layout a cada frame do scroll.
    ...
    function initTilt() {
        ...
        // Os cards OBMEP têm SVGs e superfícies grandes. Mantê-los estáveis evita
        // repaints caros enquanto o usuário percorre a timeline.
